...
export const PlaylistItem: FC<PlaylistItemProps> = ({
  ...
  return (
    <li className="w-full cursor-pointer rounded-md border border-white/10 p-3 shadow-[0_4px_8px_rgba(0,0,0,0.25)] transition-all duration-300 ease-out hover:-translate-y-2 hover:scale-[1.02] hover:border-white/40 hover:shadow-[0_10px_20px_rgba(0,0,0,0.35)]">
